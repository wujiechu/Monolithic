...
/**
 * A simple domain class for the {@link demo.order.Order} concept in the order context.
 *
...
public class Order extends BaseEntity {
     ...
     * @return the aggregate {@link demo.order_mongo.Order} with the aggregated order status
     */
    public demo.order_mongo.Order incorporate(OrderEvent orderEvent) {
