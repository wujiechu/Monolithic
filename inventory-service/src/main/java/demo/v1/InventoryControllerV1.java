...
public class InventoryControllerV1 {
    ...
    @RequestMapping(path = "/v1/products/{productId}", method = RequestMethod.GET, name = "getProduct")
    ...
    @RequestMapping(path = "/v1/inventory", method = RequestMethod.GET, name = "getAvailableInventoryForProductIds")
